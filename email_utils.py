...
def send_recovery_email(recipient_email: str, token: str):
    ...
    try:
        ...
        <body>
            ...
            <p>Olá,</p>
            <p>Você solicitou a recuperação de sua senha. Use o token abaixo para redefinir sua senha na página de recuperação.</p>
            <p>Seu token é:</p>
            <p style="font-size: 20px; font-weight: bold; background-color: #f0f0f0; padding: 10px; border-radius: 5px; text-align: center;">{token}</p>
...
def send_renewal_reminder_email(recipient_email: str, member_details: dict):
    """
